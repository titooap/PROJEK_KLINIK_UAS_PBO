...
('OBT004', 'Antasida', 40, 6000.00),
('OBT005', 'Vitamin C', 120, 3000.00),
('OBT006', 'Penyegar', 99, 800000.00);
...
--
ALTER TABLE `resep`
  ADD CONSTRAINT `fk_obat` FOREIGN KEY (`idObat`) REFERENCES `obat` (`idObat`) ON DELETE SET NULL,

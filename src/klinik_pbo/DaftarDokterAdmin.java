...
public class DaftarDokterAdmin extends javax.swing.JFrame {
    ...
    private void ButtonDeleteDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonDeleteDokterActionPerformed
        ...
        try {
            ...
            int option = JOptionPane.showConfirmDialog(null, comboBox, "Pilih Dokter untuk Dihapus", 
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                int konfirmasi = JOptionPane.showConfirmDialog(null, 
                    "Yakin ingin menghapus dokter \"" + namaDipilih + "\"?", 
                ...
                if (konfirmasi == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        tampilkanDataDokter(); // refresh tabel dokter
                    } catch (SQLException delErr) {
                        JOptionPane.showMessageDialog(null, 
                            "Gagal menghapus dokter: " + delErr.getMessage(), 

 ...
 * @author avvjelly
 */
public class ResepPasienAdmin extends javax.swing.JFrame {

    private void tampilkanDataResepPasien() {
        DefaultTableModel model = new DefaultTableModel(
            new String[]{"ID Resep", "Penyakit", "Tanggal", "Nama Pasien", "Nama Dokter", "Nama Obat", "Status"},
            0
        );
        ...
        TabelResepPasien.setModel(model);
    }

    /**
     * Creates new form ResepPasienAdmin
     */
    public ResepPasienAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabelJudulHalaman.setText("Resep Pasien"); // Specific title for this page
        ...
        TabelResepPasien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Resep", "Penyakit", "Tanggal", "Nama Pasien", "Nama Dokter", "Nama Obat", "Status"
            }
        ));
    ...
    // Note: The previous code had a typo here, ButtonResepPasien was redirecting to PendaftaranDokterAdmin
    private void ButtonResepPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonResepPasienActionPerformed
        ...
        // If you intended to have a PendaftaranResepPasienAdmin, create that form and redirect here.
    ...
    private void ButtonActionResepPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonActionResepPasienActionPerformed
        // Assuming ResepPasienController.showActionDialog() handles add/edit/delete
        new ResepPasienController("admin").showActionDialog();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResepPasienAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResepPasienAdmin().setVisible(true);
            }
        });
    }

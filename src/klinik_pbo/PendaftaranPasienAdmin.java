...
public class PendaftaranPasienAdmin extends javax.swing.JFrame {
    ...
    private void ButtonSendPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSendPasienActionPerformed
        try {
            String idPasien = TextfieldID.getText().trim();
            ...
            // Validasi input
            if (idPasien.isEmpty() || nama.isEmpty() || alamat.isEmpty() || telepon.isEmpty()) {
            ...
            // Buat objek pasien
            Pasien pasien = new Pasien(idPasien, nama, alamat, telepon);
            ...
            if (sqlEx.getMessage().contains("Duplicate") || sqlEx.getMessage().contains("UNIQUE")) {
                JOptionPane.showMessageDialog(this,
                    "Gagal menyimpan data: ID Pasien sudah digunakan.",
                    "Duplikat Data",

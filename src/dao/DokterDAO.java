...
public class DokterDAO {
    ...
    try {
        ...
        if(d.getIdUser() == null || d.getIdUser().isEmpty()) {
            String newUserId = generateNewUserId(); // Perbaikan typo 'jsrring' menjadi 'String'
            d.setIdUser(newUserId);
        }
        
        String sql = "INSERT INTO dokter (idDokter, nama, spesialisasi, idUser) VALUES (?, ?, ?, ?)"; // Tambahkan tutup kurung

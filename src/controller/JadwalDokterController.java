...
public class JadwalDokterController {
    ...
    try {
        ...
        JTextField idJadwalField = new JTextField(); // Tambahkan field untuk ID Jadwal
        ...
        Object[] fields = {
            "ID Jadwal:", idJadwalField,  // Tambahkan field ID ke form
            "Dokter:", dokterCombo,
            "Hari:", hariCombo,
        ...
        if (result == JOptionPane.OK_OPTION) {
            String idJadwal = idJadwalField.getText().trim(); // Ambil ID dari input
    ...
    private void showEditForm(Map<String, String> data) {
        try {
            ...
            if (edit == JOptionPane.OK_OPTION) {
                ...
                refreshTable(); // Method untuk refresh tabel di view
            }
        } catch (SQLException e) {
            handleError("Database Error", e);
        }
...
//    private void tambahJadwalDokter() {
//        // Implementasi tambah jadwal dokter
//        JOptionPane.showMessageDialog(null, "Fitur tambah jadwal dokter akan diimplementasikan di sini");
//    }

    private void refreshTable() {
        // Panggil method untuk refresh data di view (table)
        // Contoh: view.refreshJadwalDokterTable();
//        JadwalDokterAdmin.tampilkanDataJadwalDokter;
// Buat instance terlebih dahulu
